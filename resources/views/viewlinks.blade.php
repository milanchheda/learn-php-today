...
<div class="container-fluid container">
    ...
    ?>
        ...
        <div class="col-xs-12 col-md-4 col-lg-4 col-sm-6 linksContainer" data-toggle="tooltip" data-placement="top" style="height: 200px;" link-id={{ $user->id }}>
            <div class="well" style="height: 100%">
                ...
                <div class="pull-left actionItems">
                    <a href="#" class="view">
                        <i class="fa fa-eye fa-lg" aria-hidden="true" style="vertical-align: middle; font-size: 14px;"></i>
                        <span class="" id="view_{{ $user->id }}">0</span>
                    </a>
                    <a href="#" class="upvote" data-toggle="tooltip" data-placement="top" title="Click to Upvote.">
                        <i class="fa fa-arrow-up  fa-lg" aria-hidden="true" style="vertical-align: middle; font-size: 14px;"></i>
                    ...
                    <a href="#" class="recommend" data-toggle="tooltip" data-placement="top" title="Click to bookmark.">
                        <i class="fa fa-bookmark fa-lg recommendHeart" aria-hidden="true"  style="vertical-align: middle; font-size: 14px;"></i>
                    ...
                    <div class="pull-right socialShareButtons">
                        <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ $shareURL }}&title={{ $user->title }}&summary=&source={{ $source }}" class="linkedin">
                            <i class="fa fa-linkedin fa-lg" aria-hidden="true" style="vertical-align: middle; font-size: 14px;" data-toggle="tooltip" data-placement="top" title="Click to share on LinkedIN."></i>
                        </a>

                        <a href="http://www.facebook.com/sharer.php?u={{ $shareURL }}" target="_BLANK" class="facebook">
                            <i class="fa fa-facebook fa-lg" aria-hidden="true" style="vertical-align: middle; font-size: 14px;" data-toggle="tooltip" data-placement="top" title="Click to share on Facebook."></i>
                        </a>
                        ...
                        <a href="http://twitter.com/share?text={{ $user->title }}&url={{ $shareURL }}" class="twitter-share-button twitter" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;">
                            <i class="fa fa-twitter fa-lg" aria-hidden="true" style="vertical-align: middle; font-size: 14px;" data-toggle="tooltip" data-placement="top" title="Click to share on Twitter."></i>
                        </a>
                        <a href="http://www.reddit.com/submit?url={{ $shareURL }}&title={{ $user->title }}" target="_BLANK" class="reddit">
                            <i class="fa fa-reddit fa-lg" aria-hidden="true" style="vertical-align: middle; font-size: 14px;" data-toggle="tooltip" data-placement="top" title="Click to share on Reddit."></i>
                        </a>
                    </div>
                </div>
            </div>
