...
?>
    ...
    <div class="col-xs-12 col-md-4 col-lg-4 col-sm-6 linksContainer view-more" data-toggle="tooltip" data-placement="top" style="height: 200px;" link-id={{ $user->id }}>
        <div class="well" style="height: 100%">
            ...
            <div class="pull-left actionItems">
                ...
                <a href="#" class="recommend" data-toggle="tooltip" data-placement="top" title="Click to bookmark.">
                    <i class="fa fa-bookmark recommendHeart fa-lg" aria-hidden="true"></i>
